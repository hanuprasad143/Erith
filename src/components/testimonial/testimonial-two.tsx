...
export default function TestimonialTwo() {
  ...
  return (
    <section className="testimonial-area white-bg pb-85">
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-xxl-6 col-lg-8">
            <div className="tp-testimonial-section">
              <div className="tp-section text-center mb-40">
               <div className="tp-section text-center mb-40 wow fadeInUp" data-wow-delay=".3s"> 
                <h5 className="tp-section-3-subtitle" style={{color:"#f4d100"}}>Clients testimonial</h5>
                <h3 className="tp-section-3-title">
                  Partners{" "}
                  <span style={{color:"#f4d100"}}>
                    Say
                    <Image
