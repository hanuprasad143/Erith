      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-3">
            <div
              className="tp-banner-sm-2-wrap mb-60 wow fadeInUp"
              data-wow-delay=".3s"
            >
              <h5 className="tp-banner-sm-2-title">
          ...
          <div className="col-lg-3">
            <div
              className="tp-banner-sm-2-wrap tp-banner-sm-2-bg-2 mb-60 wow fadeInUp"
              data-wow-delay=".3s"
            >
              <h3 className="tp-banner-sm-2-title">
