               ...
               <div className="offcanvas__content">
                  ...
                  <div className="offcanvas-main">
                     ...
                     <div className="offcanvas-contact">
                        ...
                        <ul>
                           <li><a href="tel:+971 7266 2628">+971 7266 2628</a></li>
                           <li><a href="mailto:info@erithglobal.com">info@erithglobal.com</a></li>
                           <li><a href="#">Office No. 3, Plot #84, Mussafah M40, Abu Dhabi</a></li>
                        </ul>
                     </div>
